...
export class Experience {
  ...
  setMetaTags(): void {
    const pageTitle =
      'Work Experience | Satendra Rajput - Angular & Java Full Stack Developer';
    const pageDescription =
      'Explore the professional work experience of Satendra Rajput across Fine Quick Solutions, Redmil, WebConvoy, and Caria Electronics. Hands-on roles in Angular, Java Spring Boot, SaaS platforms, fintech, and LMS systems.';
    const imageUrl =
      'https://satendrasde.vercel.app/assets/images/meta-experience.jpg'; // ✅ Replace with real image
    ...
    this.meta.updateTag({
      name: 'keywords',
      content:
        'Satendra Rajput Work Experience, Fine Quick Solutions, Redmil Business, WebConvoy, Caria Electronics, Software Engineer, Angular Developer, Full Stack Developer, LMS Developer, Fintech Developer',
    });
