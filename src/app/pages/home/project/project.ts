...
export class Project {
  ...
  projects: Project_1[] = [
    // 1_SSBrinet Innovations
    {
      ...
      description:
        'Built Fine Quick Innovations, a SaaS platform with 150+ productivity tools using Angular & Spring Boot...',
    ...
    // 2_Redmil Fintech
    {
      ...
      description:
        'Contributing to the development of a comprehensive Fintech platform offering a wide range of banking...',
    ...
    // 3_Redmil HDFC
    {
      ...
      description:
        'Developed a fully functional Angular dashboard for Jan Samarth referred case reporting and management...',
    ...
    // 4_Webconvoy Gaming Platform
    {
      ...
      description:
        'Developed key frontend modules for an online gambling platform, including login, transactions, QR code payments, and player registration forms...',
    ...
    // 5_Webconvoy PPF(Paint Protection Film)
    {
      ...
      description:
        'Designed and developed a responsive and dynamic web application for showcasing and managing Paint Protection Film (PPF) services and products...',
  ...
  setMetaTags(): void {
    const pageTitle =
      'Projects by Satendra Rajput | Angular & Java Full Stack Developer';
    const pageDescription =
      'Explore major projects built by Satendra Rajput, including FineQuick SaaS, Fintech platforms, dashboards, PPF apps, and more using Angular, Java Spring Boot, and MySQL.';
    const imageUrl =
      'https://satendrasde.vercel.app/assets/images/meta-projects.jpg'; // ✅ Replace with actual thumbnail or banner
    ...
    this.meta.updateTag({
      name: 'keywords',
      content:
        'Satendra Coder Projects, Angular Projects, Java Spring Boot Portfolio, Fintech Dashboard, SaaS Platform, FineQuick, Webconvoy, PPF, Gambling Platform, Jan Samarth Dashboard, Study Library',
    });
